...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 06, 2022 at 03:29 PM
...
INSERT INTO `product` (`id`, `type`, `brand`, `name`, `price`, `description`, `quantiy`, `img_directory`) VALUES
(1, 'Laptop', 'APPLE\r\n', 'MacBookPro13\"', 5599, '8th‑generation Intel Core i5 processor, Intel Iris Plus Graphics 645, 8GB 2133MHz LPDDR3 memory and a 256GB SSD storage. It also has a 13.3‑inch (diagonal) 2560x1600 native resolution at 227 pixels per inch with support for millions of display and weighs 1.4kg.', 20, 'image/apple laptop.jpg'),
(2, 'Laptop', 'DELL\r\n', 'New XPS 17 Laptop\"', 9945, '12th Generation Intel® Core™ i7-12700H, Windows 11 Home Single Language(Dell Technologies recommends Windows 11 Pro for business) NVIDIA® GeForce RTX™ 3050, 4 GB GDDR6, 60 W16 GB, 2 x 8 GB, DDR5, 4800 MHz, dual-channel 512 GB, M.2, PCIe NVMe, SSD 17.0-in. display.', 20, 'image/dell laptop.jpg'),
(3, 'Laptop', 'ACER\r\n', 'Aspire 3 \"', 2099, '15.6\" FHD, Intel Pentium Silver N6000, 4GB RAM + 512GB SSD, Intel® UHD Graphics, Windows 10 (Preloaded MS Office Home  & Student) ', 20, 'image/acer laptop.jpg'),
(4, 'Desktop', 'APPLE\r\n', 'iMac 24\" \"', 7249, '512GB storage¹, 8GB unified memory, 24-inch 4.5K Retina display², Two Thunderbolt / USB 4 ports, Two USB 3 ports, Gigabit Ethernet, Magic Keyboard with Touch ID ', 20, 'image/imac desktop.jpg'),
(5, 'Desktop', 'DELL\r\n', 'New Inspiron Compact Desktop \"', 2099, '12th Gen Intel® Core™ i3-12100, Windows 11 Home Single Language, (Dell Technologies recommends Windows 11 Pro for business), Intel® UHD Graphics 730, 8 GB, 1 x 8 GB, DDR4, 3200 MHz,256 GB, M.2, PCIe NVMe, SSD ', 20, 'image/dell desktop.jpg'),
(6, 'Desktop', 'ACER\r\n', 'Acer Aspire AXC895-10400F \"', 1900, 'Intel® Core™ i5-10400 Processor, 4 GB DDR4 2666 MHz UDIMM (upgradable to 16GB*2) Ram, 512GB SSD, Intel® UHD Graphics 630, DOS ( No Windows ), 3 Years Acer Malaysia Onsite Warranty. ', 20, 'image/acer desktop.jpg'),
(7, 'Monitor', 'AOC\r\n', 'AGON 27\" Premium Gaming Monitor \"', 900, 'ICompetitively modeled for agile execution on the battlefield, the AG273FZE AGON III 27” gaming monitor has 240Hz refresh rate and 0.5ms response time. The display’s G-Sync Compatible technology ensures the monitor’s refresh rate is seamlessly synced with your processor’s to eliminate screen tearing. With brighter lights, darker shadows and more vivid colors, the monitor’s HDR technology illuminates with pristine visuals. Whether you want to flash team colors at an e-sports event or create the ultimate gaming ambience with the 13 default modes, AOC’s Light FX can transcend your gaming experience beyond the screen. ', 20, 'image/aoc monitor.jpg'),
(8, 'Monitor', 'DELL\r\n', 'Dell 23\" Full HD Monitor P2317H \"', 500, 'Affordable and reliable 23” IPS monitor with wide viewing angle and essential features that drive productivity, Get consistent colors across a wide viewing angle, enabled by In-plane switching technology on a 23” full HD screen, Optimize eye comfort with a flicker-free screen and comfort view feature which minimizes blue light emission, Compatible with most legacy and current PCs via VGA and HDMI connectivity (Ports vary depending on models). Compatibility- All operating system, Flexibility to configure with Dell mounts and stands options for evolving office requirements. Refresh rate:60 Hz ', 20, 'image/dell monitor.jpg'),
...
(16, 'Smartphone', 'APPLE\r\n', 'IPHONE 13 \"', 3899, 'We designed a totally new architecture and turned the lenses 45 degrees to fit in our best dual-camera system ever — with its biggest Wide camera sensor. We also made room for our sensor-shift optical image stabilisation. And we equipped the Ultra Wide camera with a faster sensor.', 20, 'image/iphone.jpg'),
...
(1, 'WorstPie', '$2y$10$HsymJtMj5ruEDHQI/2eGuu5yGS.GXVKX2qlfcR1U7vhXvPJGcyOCC', '', 0, '', '2022-04-05 23:27:02');
COMMIT;
