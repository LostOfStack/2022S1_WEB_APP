...
<body>
    ...
    <div class="myhome">
        ...
        <div class="rowhome">
            ...
            <p style="font-size:50px;position:static;top:110px;">MacBookPro13"<br>RM 5,599<br><br>Feature:<br>Retina display<br>Apple M1 chip<br>Backlit Magic Keyboard<br>Two Thunderbolt / USB 4 ports with support<br><br>
            </p>
            </div>
            <div class="columnhome">
            <a href="cart.php">
            ...
            <p style="font-size:50px;position:static;top:30px;">Dell XPS 13<br>RM6,979<br><br>Feature:<br>3200x1800 pixels<br>TouchScreen<br>128GB SSD Storage<br><br></p>
            </div>
        </div>
    </div>
    <style>
